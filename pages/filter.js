...
export default function News() {
    // State to handle the search term and filtered data
    ...
    return (
        <div className="h-screen bg-indigo-100">
            <div className=" flex justify-center "><h1 className="mt-5 font-bold text-xl mb-3">Хэрэглэгчийн жагсаалт</h1></div>
